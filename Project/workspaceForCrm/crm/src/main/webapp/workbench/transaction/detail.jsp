<%@ page import="com.javastudy.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.javastudy.crm.workbench.domain.Tran" %>
...
<%
    ...
    for(int i = 0; i < dvList.size(); i++){
        DicValue dv = dvList.get(i);  //获取每个字典值
...
<script type="text/javascript">
	...
	function showHistoryList(){
        $.ajax({
            ...
            success : function(data){
                /*
                data:{{TranHistory1},{TranHistory2},...}
                 */
    ...
    function changeStage(stage,i){
        $.ajax({
            ...
            success : function(data){
                /*
                data:{"flag":true/false,"t":{Tran}}
                 */
                if(data.flag){
                    //刷新详细信息页的阶段、可能性、修改人、修改时间
    ...
    function changeIcon(stage,i){
        ...
        var currentPossibilty = $("#possibility").html();
        //当前阶段下标
        var index = i;
        //正常阶段和丢失阶段分界点下标
        var point = "<%=point%>";
        if(currentPossibilty == "0"){
